...
public class Iteration6_MovementOverTimeTest {
    ...
    @Test
    public void testMultiplePiecesMovingSimultaneously() {
        // Move white king from (0, 0) to (0, 1)
        gameController.handleClick(50, 50);
        gameController.handleClick(100, 50);
        
        // Move black king from (7, 7) to (7, 6)
        gameController.handleClick(750, 750);
        gameController.handleClick(650, 750);
        ...
        // Wait more
        gameController.advanceTime(600);
